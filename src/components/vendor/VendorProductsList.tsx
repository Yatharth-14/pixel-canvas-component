...
const mockProducts = [
  {
    ...
    rating: 4.5,
    reviewCount: 42,
    description: "Digital medical thermometer with high precision sensors for accurate temperature readings.",
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 28,
    description: "Automatic digital blood pressure monitor with high accuracy and memory function.",
  ...
  },
  {
    ...
    rating: 4.3,
    reviewCount: 15,
    description: "Measures oxygen saturation levels (SpO2) and pulse rate quickly and accurately.",
  ...
  },
  {
    ...
    rating: 4.1,
    reviewCount: 37,
    description: "Non-contact infrared thermometer for quick and hygienic temperature measurement.",
                ...
                <div className="bg-white border border-gray-100 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-baseline mt-2 mb-1">
                      <span className="text-xl font-bold text-gray-900">₹{product.discountPrice.toLocaleString()}</span>
                    ...
                    <div className="flex items-center">
                      <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className={`w-3 h-3 ${i < Math.floor(product.rating) ? "text-yellow-400" : "text-gray-300"}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                      ...
                      <Badge variant="outline" className="ml-auto bg-green-50 text-green-700 text-xs border-green-100">
                        {product.status}
                      </Badge>
                    </div>
